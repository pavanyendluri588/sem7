...
library(arules)
getwd()
read.csv("D:\\sem7\\INT234PREDICTIVE ANALYTICS\\mam_sent _files\\mam_sent_dataset_files\\groceries.csv")
groceries <- read.transactions("D:\\sem7\\INT234PREDICTIVE ANALYTICS\\mam_sent _files\\mam_sent_dataset_files\\groceries.csv", sep = ",")
groceries
